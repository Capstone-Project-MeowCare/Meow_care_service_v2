...
public interface TransactionRepository extends JpaRepository<Transaction, UUID> {
    ...
    List<Transaction> search(@Nullable UUID id, @Nullable TransactionStatus status, @Nullable PaymentMethod paymentMethod, @Nullable String transactionType);
    ...
    List<Transaction> search(@Nullable UUID id, @Nullable TransactionStatus status, @Nullable PaymentMethod paymentMethod, @Nullable String transactionType, Instant fromTime, Instant toTime);
