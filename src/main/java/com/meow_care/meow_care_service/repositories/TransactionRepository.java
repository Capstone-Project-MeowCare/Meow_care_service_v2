...
public interface TransactionRepository extends JpaRepository<Transaction, UUID> {
    ...
    Page<Transaction> search(@Nullable UUID id, @Nullable TransactionStatus status, @Nullable PaymentMethod paymentMethod, @Nullable TransactionType transactionType, Pageable pageable);
    ...
    Page<Transaction> search(@Nullable UUID id, @Nullable TransactionStatus status, @Nullable PaymentMethod paymentMethod, @Nullable TransactionType transactionType, Instant fromTime, Instant toTime, Pageable pageable);
