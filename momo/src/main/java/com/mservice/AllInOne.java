...
//        orderId = String.valueOf(System.currentTimeMillis());
//        requestId = String.valueOf(System.currentTimeMillis());
//        PaymentResponse captureCreditMoMoResponse = CreateOrderMoMo.process(environment, orderId, requestId, Long.toString(amount), orderInfo, returnURL, notifyURL, "", RequestType.PAY_WITH_CREDIT, null);
//        System.out.println(captureCreditMoMoResponse.getPayUrl());
